...
public class MemberDAOImpl implements MemberDAO {
	...
	public void register(MemberVO vo) throws Exception {
		System.out.println("  [  1. DAO. register. 회원가입. 접속. ] ");
		sql.insert("memberMapper.register", vo);
		System.out.println("  [  2. DAO. register. 회원가입. vo. = ] " + vo);
	}
	...
	public MemberVO login(MemberVO vo) throws Exception {
		...
		System.out.println("  [ DAO login  로그인 ]");
	...
	public int passChk(MemberVO vo) throws Exception {
		...
		System.out.println("  [ DAO passChk result  ]  = " + result);
		return result;
	}
	...
	public int idChk(MemberVO vo) throws Exception {
		System.out.println("  [  1. DAO. idChk. ID중복체크. 접속. ] ");
		int result = sql.selectOne("memberMapper.idChk", vo);
		
		System.out.println("  [  2. DAO. idChk. ID중복체크. result. = ] " + result);
		return result;
	}
